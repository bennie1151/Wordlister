...
print('//__.....----~~~~._\ | /_.~~~~----.....__\\')
print('====================\|/====================')
print(' Wordlister.py - Coded by გიო რგი & S4RR4\n')
...
name = input("შეიყვანეთ მსხვერპლის სახელი: ")
lname = input("\nშეიყვანეთ მსხვერპლის გვარი: ")
bgfriendN = input("\nშეიყვანეთ მსხვერპლის შეყვარებულის სახელი: ")
bgfriendL = input("\nშეიყვანეთ მსხვერპლის შეყვარებულის გვარი: ")
byear = input("\nშეიყვანეთ მსხვერპლის დაბადების წელი: ")
bmonth = input("\nშეიყვანეთ მსხვერპლის დაბადების თვე რიცხვით (მაგ. 05 ან 11): ")
bday = input("\nშეიყვანეთ მსხვერპლის დაბადების რიცხვი: ")
bday2 = input("\nშეიყვანეთ მსხვერპლის ახლობლის დაბადების რიცხვი (10-ზე ნაკლებს დაუწერეთ წინ 0): ")
color = input("\nშეიყვანეთ მსხვერპლის საყვარელი ფერი: ")
pet = input("\nშეიყვანეთ მსხვერპლის შინაური ცხოველის (Pet) სახელი: ")
country = input("\nშეიყვანეთ ქვეყანა სადაც მსხვერპლი იმოგზაურებდა: ")
city = input("\nშეიყვანეთ ქალაქი სადაც მსხვერპლი იცხოვრებდა: ")
